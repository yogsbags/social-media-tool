...
async function testWebinarCreation() {
  ...
  try {
    ...
    const webinarResult = await client.createWebinar({
      ...
      avatar_id: avatarId,
      voice_id: voiceId,
      introduction_text: `Hello, I'm the spokesperson, Fund Manager at the brand. Welcome to this webinar on factor investing. Today, I'll explain how systematic investment strategies can help you build wealth over the long term.`,
      main_content_text: `Factor investing is a systematic approach to portfolio construction that focuses on specific drivers of returns. These factors include value, momentum, quality, and low volatility. Our adaptive strategy strategy leverages multiple factors to identify investment opportunities. Over the past year, adaptive strategy has delivered strong returns by systematically selecting stocks based on quantitative models rather than emotional decisions. The key advantage of factor investing is its repeatable, data-driven process. We analyze thousands of data points to identify stocks that meet our criteria. This approach removes human bias and focuses on what the data tells us.`,
      conclusion_text: `In conclusion, factor investing offers a disciplined approach to wealth creation. By focusing on systematic factors and removing emotion from investment decisions, we can build portfolios that perform consistently over time. Thank you for joining this webinar. For more information, visit example.com.`,
      duration_minutes: 5
    });
